...
class INurse extends Component {

  constructor(props){   
    super(props);
    this.state={
      title: 'Intern Nurse data',
      act: 0,
      index: '',
      datas: []
    }
  ...
  fSubmit = (e) =>{
    ...
    if(this.state.act === 0){   //new
      let data = {
        name, address, surname, ldoc, phone, email
      }
      datas.push(data);
  ...
  fEdit = (i) => {
    ...
    this.refs.ldoc.value = data.ldoc;
    ...
    return (
      <div className="App">
        ...
        <form ref="myForm" className="myForm">
          ...
          <input type="text" ref="ldoc" placeholder="Enter leading doctor" className="formField" />
        ...
        <pre>
          {datas.map((data, i) =>
            <li key={i} className="myList">
              {i+1}. {data.name}, {data.surname}, {data.ldoc}, {data.phone}, {data.address}, {data.email}
